...
use rPDO\Exception\Container\ContainerException;
use rPDO\Exception\Container\NotFoundException;
 ...
 * @package rPDO
 */
class rPDOContainer implements ContainerInterface, ArrayAccess
{
