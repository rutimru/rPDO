...
/**
 * An extension for generating {@link rPDOObject} class and map files for MySQL.
 *
 * A MySQL-specific extension to an {@link rPDOManager} instance that can
 * generate class stub and meta-data map files from a provided XML schema of a
 * database structure.
 *
 * @package rPDO\Om\mysql
 */
class rPDOGenerator extends \rPDO\Om\rPDOGenerator {
    ...
    /**
     * Write an rPDO XML Schema from your database.
     *
     ...
     * extend; by default this is set to {@link rPDOObject} and any
     * auto_increment fields with the column name 'id' will extend {@link
     * rPDOSimpleObject} automatically.
     ...
     * Specify a prefix when creating a new {@link rPDO} instance to recreate
                    ...
                    foreach ($fields as $field) {
                        ...
                        if (!empty ($Extra)) {
                            if ($Extra === 'auto_increment') {
                                if ($baseClass === 'rPDO\Om\rPDOObject' && $Field === 'id') {
                                    $extends= 'rPDO\Om\rPDOSimpleObject';
                                    continue;
                                } else {
