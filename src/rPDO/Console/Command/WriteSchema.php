<?php
namespace rPDO\Console\Command;
...
final class WriteSchema extends Command
{
    protected function configure()
    {
        $this
            ...
            ->addArgument(
                ...
                'An optional base_class to use for the generated schema objects; default is rPDO\Om\rPDOObject',
                ''
            )
            ->addArgument(
                'table_prefix',
                InputArgument::OPTIONAL,
                'An optional table_prefix to override one specified for the rPDO configuration',
                ''
            )
            ->addOption(
                'restrict_prefix',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            $xpdo = rPDO::getInstance('generator', $properties["{$platform}_array_options"]);
